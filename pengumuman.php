...
<head>
	...
	<title>TK Al-Bina | Pengumuman</title>
...
<body id="my-top">
    ...
    <div id="wrapper">
							...
							<div class="container">
								...
								<div class="collapse navbar-collapse" id="navbarNav">
									<ul class="navbar-nav mr-auto">
										...
										<li class="nav-item">
										<a class="nav-link activeku" href="pengumuman.php" tabindex="-1" aria-disabled="true">Pengumuman</a>
										</li>
									</ul>
								</div>
							</div>
		...
		<div class="pengumuman-ctn">
			<div class="container-xl">
				<h1 data-0-top="opacity:0;bottom:200px;" data-70-top="opacity:1;bottom:0px;">Pengumuman</h1>
				<div class="row">
					<div class="col-md-3" data-top-bottom="opacity:0;bottom:200px;" data-center-center="opacity:1;bottom:0px;">
						<div class="card">
							<a href="lihat-berita.html"><img src="assets/pic3.jpg" class="card-img-top" alt="..."></a>
							<div class="card-body">
								<p><i class="fas fa-calendar"></i> Jum'at, 8 Mei 2020</p>
								<a href="lihat-berita.html"><p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p></a>
								<p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
							</div>
						  </div>
					</div>
					<div class="col-md-3" data-top-bottom="opacity:0;bottom:150px;" data-center-center="opacity:1;bottom:0px;">
						<div class="card">
							<a href="lihat-berita.html"><img src="assets/pic3.jpg" class="card-img-top" alt="..."></a>
							<div class="card-body">
								<p><i class="fas fa-calendar"></i> Jum'at, 8 Mei 2020</p>
